...
var fragments = function (text)
{
    ...
    var mapping = {
        middleButton: element.bind(null, by.id('paulaMid')),
        warningAlert: element.bind(null, by.id('paulaWarr')),
        input: element.bind(null, by.id('paulaInp')),
        header: element.bind(null, by.id('paulaH'))
    };
